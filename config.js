...
const CONFIG = {
  ...
  fans: {
    ...
    subtitle: { it: "Chi ci supporta dal bordo campo, con la fede, con la birra in mano. Eroi silenziosi.",
  ...
  board: {
    ...
    members: [
      { name: "Giec",   role: { it: "Mastermind & Devil Reincarnated",       en: "Mastermind & Devil Reincarnated"    }, bio: { it: "Il cervello dietro tutto. O almeno così dice lui.",                                                          en: "The brain behind everything. Or so he claims."                                              }, photo: "photos/giec.png" },
      { name: "Ali",    role: { it: "Super Social Media Manager",            en: "Super Social Media Manager"        }, bio: { it: "Gestisce i social con stile. Ha anche dei difetti, ma non è questo il momento.",                            en: "Manages socials with style. She also has flaws, but this is not the time."                  }, photo: "photos/ali.png" },
      { name: "Rwu",    role: { it: "Segretaria, aguzzina e ricattatrice",   en: "Secretary, tormentor & blackmailer"}, bio: { it: "Tiene i registri, tiene le redini e tiene in pugno tutti. Ha anche dei difetti.",                           en: "Keeps the records, the reins, and everyone in her grip. She also has flaws."               }, photo: "photos/ru.png" },
      { name: "Shudo",  role: { it: "Tesoriere",                             en: "Treasurer"                        }, bio: { it: "Controlla il budget. Spoiler: non basta mai.",                                                              en: "Controls the budget. Spoiler: it's never enough."                                           }, photo: "photos/shu.png" },
      { name: "Divino", role: { it: "L'unico e il solo",                     en: "The one and only"                 }, bio: { it: "Non ha bisogno di presentazioni. Lo sa anche lui.",                       en: "Needs no introduction. He knows it too."                    }, photo: "photos/divi.png" },
